...
export default function WaitlistPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      {/* Main Content */}
      <div className="relative z-10 min-h-screen flex flex-col items-center px-2 py-8 md:py-12">
        {/* Logo */}
        <img
  src="/logo.png"
        ...
        <div className="w-full max-w-182.5 md:max-w-4xl flex flex-col items-center text-center">
          ...
          <div className="mt-auto pt-14 pb-8 animate-fadeIn animation-delay-1000">
            ...
            <div className="flex justify-center gap-5 mb-8">
              <a 
                href="https://www.instagram.com/designandbuildhq?igsh=MWZtNDI1bngzM3dndw==" 
                target="_blank" 
              ...
              <a 
                href="https://www.linkedin.com/posts/designandbuild-hq_designandbuildhq-productteams-startupbuilding-activity-7420436251406868480-WkdE?utm_source=share&utm_medium=member_ios&rcm=ACoAAEXIVrMBt7s0yECvJvy8in80a3sa6-BbDKo" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-white/70 hover:text-white transition-colors duration-200"
